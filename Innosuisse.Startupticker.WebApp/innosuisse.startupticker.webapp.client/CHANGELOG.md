...
- Create Angular project with ng: `ng new innosuisse.startupticker.webapp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`innosuisse.startupticker.webapp.client.esproj`).
