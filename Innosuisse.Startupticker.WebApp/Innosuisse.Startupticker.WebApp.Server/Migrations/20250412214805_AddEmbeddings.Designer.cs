...
namespace Innosuisse.Startupticker.WebApp.Server.Migrations
{
    ...
    [Migration("20250412214805_AddEmbeddings")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Innosuisse.Startupticker.WebApp.Server.Data.Entities.Startup", b =>
                {
                    ...
                    b.Property<decimal?>("FundingRoundsCount")
                    ...
                    b.Property<DateTime?>("LastFundedOn")
                        .HasColumnType("datetime2");

                    b.Property<decimal?>("LastValuation")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Innosuisse.Startupticker.WebApp.Server.Data.Entities.StartupTag", b =>
                {
                    b.Property<Guid>("StartupId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasKey("StartupId", "Name");

                    b.ToTable("StartupTag", "dbo");
                });
            ...
            modelBuilder.Entity("Innosuisse.Startupticker.WebApp.Server.Data.Entities.StartupFundingRound", b =>
                {
                    b.HasOne("Innosuisse.Startupticker.WebApp.Server.Data.Entities.Startup", "Startup")
                        .WithMany("StartupsFundingRounds")
            ...
            modelBuilder.Entity("Innosuisse.Startupticker.WebApp.Server.Data.Entities.Startup", b =>
                {
                    b.Navigation("StartupsFundingRounds");
